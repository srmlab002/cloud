...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'srm@wkwt0.onmicrosoft.com' ,
  ...
  footer:
    'Powered by <a href="https://srm.pages.dev" target="_blank" rel="noopener noreferrer"</a>. Made with ❤ by Venkatesh',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: ['/private', '/logs', '/p', '/q' ,'/r', '/s'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:issue@srmlab.33mail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/srmcloud',
    },
  ],
